...
Route::get('/', function () {return inertia('Authentication/Index'); });
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('directory')->group(function(){
        ...
        Route::resource('/courses', App\Http\Controllers\Directory\CourseController::class);
...
Route::get('/names', [App\Http\Controllers\Directory\SchoolController::class, 'names']);
