            ...
            <tbody>
                <tr v-for="(list,index) in lists" v-bind:key="index" :class="[(list.is_active == 0) ? 'table-warnings' : '']">
                    ...
                    <td class="text-end">
                        ...
                        <b-button variant="soft-danger" @click="openView(list)" v-b-tooltip.hover title="View" size="sm" class="remove-list me-1">
                            <i class="ri-eye-fill align-bottom"></i>
                        </b-button>
                        <b-button @click="openEdit(list,index)" variant="soft-primary" v-b-tooltip.hover title="Edit" size="sm" class="edit-list me-1">
...
export default {
    props: ['agencies'],
    components : { Pagination, Multiselect, Create, Update, View },
    data(){
        return {
