    ...
    <PageHeader :title="title" :items="items" />
     <div class="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
        <div class="file-manager-sidebar">
            <Sidebar :total="total" :ongoing="ongoing" :year="year" :endorsed="endorsed" :statistics="statistics"/>
        </div>
...
export default {
    props: ['total','ongoing','year','endorsed','statistics','dropdowns','programs','regions','statuses'],
    components : { PageHeader, Sidebar, Lists },
    data() {
        return {
            currentUrl: window.location.origin,
            title: "List of Qualifiers",
            items: [{text: "Qualifier",href: "/"},{text: "Lists",active: true}],
        };
    },
    computed: {
