...
<b-row class="g-2 mb-2 mt-n2">
        <b-col lg>
            <div class="input-group mb-1">
                ...
                <input type="text" v-model="filter.keyword" placeholder="Search Endorsement" class="form-control" style="width: 50%;">
        ...
        <table class="table table-nowrap align-middle mb-0">
            <thead class="table-light">
                <tr class="fs-11">
                    ...
                    <th style="width: 15%;" class="text-center">Endorsed To</th>
